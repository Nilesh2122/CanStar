              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <input type="hidden" id="user_id" class="form-control" name="user_id" value="<?php echo $user['user_id']; ?>">
                    <input type="text" class="form-control" id="tb-fname" name="fname" placeholder="Enter Name here" required value="<?php echo $user['fname']; ?>"/>
                    <label for="tb-fname">First Name</label>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-floating mb-3">
                    <input type="text" class="form-control" id="tb-lname" name="lname" placeholder="Enter Name here" required value="<?php echo $user['lname']; ?>"/>
                    <label for="tb-lname">Last Name</label>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-floating mb-3">
                    <input type="email" class="form-control" id="tb-email" name="email" placeholder="name@example.com" required value="<?php echo $user['email']; ?>"/>
                    <label for="tb-email">Email address</label>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-floating">
                    <input type="password" class="form-control" id="tb-pwd" name="password" placeholder="Password" required value="<?php echo base64_decode($user['password']); ?>"/>
                ...
                <div class="col-md-6">
                  ...
                  <select class="form-control form-select" name="role" id="tb-role" required>
                        ...
                        <option value="2" <?php echo ($user['role'] == 2) ? 'selected' : ''; ?>>Installer</option>
                        <option value="3" <?php echo ($user['role'] == 3) ? 'selected' : ''; ?>>Operations</option>
                        <option value="4" <?php echo ($user['role'] == 4) ? 'selected' : ''; ?>>Sales</option>
                      </select>
