                  ...
                  <div class="row mt-4">
                    <div class="col-md-4">
                      <div class="card overflow-hidden shadow-none border card-hover mb-4 mb-md-0">
                        <img src="<?php echo base_url(); ?>assets/images/crypto/c1.jpg" alt="img" />
                        <div class="card-body p-4">
                          <div class="d-flex align-items-center justify-content-between">
                            ...
                            <img src="<?php echo base_url(); ?>assets/images/profile/user-1.jpg" alt="user1" width="35" class="rounded-circle" />
                          </div>
                    ...
                    <div class="col-md-4">
                      <div class="card overflow-hidden shadow-none border card-hover mb-4 mb-md-0">
                        <img src="<?php echo base_url(); ?>assets/images/crypto/c2.jpg" alt="img" />
                        <div class="card-body p-4">
                          <div class="d-flex align-items-center justify-content-between">
                            <div>
                            ...
                            <img src="<?php echo base_url(); ?>assets/images/profile/user-2.jpg" alt="user1" width="35" class="rounded-circle" />
                          </div>
                          <div class="d-flex align-items-start justify-content-between mt-3">
                            <span>Price</span>
                            <div class="text-end">
                    ...
                    <div class="col-md-4">
                      <div class="card overflow-hidden shadow-none border card-hover mb-4 mb-md-0">
                        <img src="<?php echo base_url(); ?>assets/images/crypto/c3.jpg" alt="img" />
                        <div class="card-body p-4">
                          <div class="d-flex align-items-center justify-content-between">
                            <div>
                            ...
                            <img src="<?php echo base_url(); ?>assets/images/profile/user-3.jpg" alt="user1" width="35" class="rounded-circle" />
                          </div>
                          <div class="d-flex align-items-start justify-content-between mt-3">
                            <span>Price</span>
                            <div class="text-end">
                ...
                <div class="card-body p-4">
                  ...
                  <div class="d-flex align-items-center gap-2 mt-4 mb-3">
                    <a href="javascript:void(0)">
                      <img src="<?php echo base_url(); ?>assets/images/profile/user-1.jpg" class="rounded-circle" alt="t1" width="40" />
                    </a>
                    <a href="javascript:void(0)">
                      <img src="<?php echo base_url(); ?>assets/images/profile/user-2.jpg" class="rounded-circle" alt="t2" width="40" />
                    </a>
                    <a href="javascript:void(0)">
                      <img src="<?php echo base_url(); ?>assets/images/profile/user-3.jpg" class="rounded-circle" alt="t3" width="40" />
                    </a>
                    <a href="javascript:void(0)">
                  ...
                  <div class="mb-3">
                    <span class="badge px-2 d-inline-flex align-items-center bg-light-primary text-primary rounded-pill fs-3">
                      <img src="<?php echo base_url(); ?>assets/images/profile/user-1.jpg" class="rounded-circle me-1" alt="user1" width="30" /> John </span>
                  </div>
                  <span class="d-block mb-1">Amount</span>
