<div class="container-fluid">
    ...
    <div class="item">
        ...
        <div class="card-body">
            ...
            <img src="<?php echo base_url(); ?>assets/images/svgs/icon-user-male.svg" width="50" height="50" class="mb-3" alt="" />
    ...
    <div class="item">
        ...
        <div class="card-body">
            <div class="text-center">
            <img src="<?php echo base_url(); ?>assets/images/svgs/icon-briefcase.svg" width="50" height="50" class="mb-3" alt="" />
    ...
    <div class="item">
        ...
        <div class="card-body">
            <div class="text-center">
            <img src="<?php echo base_url(); ?>assets/images/svgs/icon-mailbox.svg" width="50" height="50" class="mb-3" alt="" />
    ...
    <div class="item">
        ...
        <div class="card-body">
            <div class="text-center">
            <img src="<?php echo base_url(); ?>assets/images/svgs/icon-favorites.svg" width="50" height="50" class="mb-3" alt="" />
    ...
    <div class="item">
        ...
        <div class="card-body">
            <div class="text-center">
            <img src="<?php echo base_url(); ?>assets/images/svgs/icon-speech-bubble.svg" width="50" height="50" class="mb-3" alt="" />
    ...
    <div class="item">
        ...
        <div class="card-body">
            <div class="text-center">
            <img src="<?php echo base_url(); ?>assets/images/svgs/icon-connect.svg" width="50" height="50" class="mb-3" alt="" />
    ...
    <div class="col-lg-4">
        ...
        <div class="card-body">
            ...
            <div class="me-3 pe-1">
                <img src="<?php echo base_url(); ?>assets/images/profile/user-1.jpg" class="shadow-warning rounded-2" alt="" width="72" height="72" />
            </div>
            <div>
            ...
            <ul class="hstack mb-0">
                ...
                <a href="javascript:void(0)" class="me-1">
                    <img src="<?php echo base_url(); ?>assets/images/profile/user-2.jpg" class="rounded-circle border border-2 border-white" width="44" height="44" alt="" />
                </a>
                </li>
                <li class="ms-n8">
                <a href="javascript:void(0)" class="me-1">
                    <img src="<?php echo base_url(); ?>assets/images/profile/user-3.jpg" class="rounded-circle border border-2 border-white" width="44" height="44" alt="" />
                </a>
                </li>
                <li class="ms-n8">
                <a href="javascript:void(0)" class="me-1">
                    <img src="<?php echo base_url(); ?>assets/images/profile/user-4.jpg" class="rounded-circle border border-2 border-white" width="44" height="44" alt="" />
                </a>
                </li>
                <li class="ms-n8">
                <a href="javascript:void(0)" class="me-1">
                    <img src="<?php echo base_url(); ?>assets/images/profile/user-5.jpg" class="rounded-circle border border-2 border-white" width="44" height="44" alt="" />
                </a>
                </li>
            </ul>
    ...
    <div class="col-lg-4 d-flex align-items-strech">
        ...
        <div class="card-body pb-0">
            ...
            <img src="<?php echo base_url(); ?>assets/images/backgrounds/piggy.png" class="img-fluid" alt="" />
            </div>
        </div>
        ...
        <div class="card-body">
            ...
            <table class="table align-middle text-nowrap mb-0">
                ...
                <tr>
                    ...
                    <div class="d-flex align-items-center">
                        <div class="me-2 pe-1">
                        <img src="<?php echo base_url(); ?>assets/images/profile/user-2.jpg" class="rounded-circle" width="40" height="40" alt="" />
                        </div>
                        <div>
                ...
                <tr>
                    ...
                    <div class="d-flex align-items-center">
                        <div class="me-2 pe-1">
                        <img src="<?php echo base_url(); ?>assets/images/profile/user-3.jpg" class="rounded-circle" width="40" height="40" alt="" />
                        </div>
                        <div>
                ...
                <tr>
                    ...
                    <div class="d-flex align-items-center">
                        <div class="me-2 pe-1">
                        <img src="<?php echo base_url(); ?>assets/images/profile/user-4.jpg" class="rounded-circle" width="40" height="40" alt="" />
                        </div>
                        <div>
                ...
                <tr>
                    ...
                    <div class="d-flex align-items-center">
                        <div class="me-2 pe-1">
                        <img src="<?php echo base_url(); ?>assets/images/profile/user-5.jpg" class="rounded-circle" width="40" height="40" alt="" />
                        </div>
                        <div>
